...
import { SheetPreview } from '../../../components/previews/SheetPreview';
...
<DevicePreview
  ios={<SheetPreview platform="ios" />}
  android={<SheetPreview platform="android" />}
/>

## Installation

```bash
npx @codervigi/rn-shad-cli@latest add sheet
```
